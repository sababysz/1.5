...
function alternarVisibilidade() {
  var elemento = document.getElementById("lindo");
...
function alternarVisibilidade1() {
  var elemento = document.getElementById("lindo-1");
...
function alternarVisibilidade2() {
  var elemento = document.getElementById("lindo-2");
